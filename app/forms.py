...
class MultialignForm(FlaskForm):
    class Meta:
        csrf = False
    languages = SelectMultipleField('Target languages: ', validators=[Required()], render_kw={'data-live-search': 'true'}, choices=list(align_reader.file_lang_name_mapping.items()))
