...
corpus_stat_types = [('edition_pair_token_totcount_stats', 'edition pair corpus size'), ('lang_pair_token_totcount_stats', 'language pair corpus size')]
...
vocab_per_verse_stat_types = [('edition_perverse_single_vocab', 'edition vocab size per verse'), ('language_perverse_single_vocab', 'language vocab size per verse'), ('language_permutualverse_vocab', 'language translation pair per verse count'), ('edition_permutualverse_vocab', 'edition translation pair per verse count')]
...
def is_perverse(stat_type):
    if stat_type in vocab_per_verse_stat_vals or stat_type in token_repetition_perverse_stat_vals:
        return True
    return False
...
perverse_original_file = {'edition_perverse_single_vocab': 'edition_token_stats', 'language_perverse_single_vocab': 'lang_token_stats', 'language_permutualverse_vocab': 'lang_pair_token_count_stats', 'edition_permutualverse_vocab': 'edition_pair_token_count_stats'}
